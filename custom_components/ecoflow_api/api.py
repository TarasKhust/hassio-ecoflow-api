...
class EcoFlowApiClient:
    ...
    def _generate_signature(
        ...
        """
        # Flatten nested params for signing
        ...
        if sorted_params:
            ...
            sign_str = f"{query_string}&accessKey={self._access_key}&nonce={nonce}&timestamp={timestamp}"
        else:
            sign_str = f"accessKey={self._access_key}&nonce={nonce}&timestamp={timestamp}"
