...
class EcoFlowApiClient:
    ...
    def _get_headers(
        ...
        # Include params in signature (query for GET, body for PUT/POST)
        sign_str = f"{params_str}&{auth_str}" if params_str else auth_str
    ...
    async def set_ac_charging_power(self, device_sn: str, power: int, pause: bool = False) -> dict[str, Any]:
    ...
    async def set_lcd_standby_time(self, device_sn: str, seconds: int) -> dict[str, Any]:
